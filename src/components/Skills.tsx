import { Card, CardBody, CardHeader, Heading, ListItem, SimpleGrid, UnorderedList } from "@chakra-ui/react";
import { FC } from "react";

const Skills: FC = () => {
    return (
        <SimpleGrid spacing={3} templateColumns='repeat(auto-fill, minmax(300px, 400px))' pt='4rem' pl='1rem' pr='1rem' pb='30px'>
